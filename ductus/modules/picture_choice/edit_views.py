...
@register_creation_view(PictureChoiceLesson, description=ugettext_lazy('a phrase is displayed as a prompt with four pictures as possible answers'), category='lesson')
